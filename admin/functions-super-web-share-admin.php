...
function superwebshare_register_settings_fallback() {
	...
	add_settings_field(
		...
		__( 'Disable the fallback modal window on desktop device', 'super-web-share' ),           // Title.
...
function sws_get_social_networks() {
	...
	$networks = array(
		...
		'mastodon'  => array(
			'name'  => __( 'Mastodon', 'super-web-share' ),
			'icon'  => 'icon-mastodon',
			'link'  => 'https://mastodonshare.com/?text={title}&url={url}',
			'color' => '#6364ff',
		),
	);
