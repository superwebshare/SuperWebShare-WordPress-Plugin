...
#### Bugfix:
* Fixed an error on the AMP page when the legacy AMP version is selected. Thanks to [mfonabel](https://wordpress.org/support/users/mfonabel/) for reporting this issue.
